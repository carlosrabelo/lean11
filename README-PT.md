...
**Otimizador modular de imagens Windows 11 com preservação de Edge e Copilot**

---

## Sobre

Lean11 é uma ferramenta PowerShell que automatiza a criação de imagens Windows 11 otimizadas através de uma arquitetura baseada em componentes modulares e configuração declarativa. Ao contrário de abordagens tradicionais, utiliza hashtables para definição de comportamento e sistema de logging multinível.

## Scripts

- `lean11.ps1`: Otimizador unificado Windows 11 com modos de operação duplos:
  - **Modo Image**: Cria ISO otimizada montando imagem original, removendo bloatware, aplicando ajustes de registro e exportando nova mídia de instalação
  - **Modo Debloat**: Aplica o mesmo conjunto de remoções e otimizações diretamente em instalação existente do Windows 11, sem reconstruir ISO
...
Os seguintes componentes permanecem **100% funcionais**:

- Microsoft Edge (navegador padrão)
- Windows Copilot (assistente IA)
- Microsoft Store (instalação de aplicativos)
- Windows Defender (segurança)
- Sistema de atualização (Windows Update)
